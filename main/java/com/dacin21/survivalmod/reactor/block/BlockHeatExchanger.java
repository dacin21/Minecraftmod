...
public class BlockHeatExchanger extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister
				.registerIcon("survivalmod:exchanger_side");
		this.iconTop = par1IconRegister.registerIcon("survivalmod:exchanger_top");
		this.iconBot = par1IconRegister.registerIcon("survivalmod:exchanger_bot");
	}
	...
	public boolean onBlockActivated(World par1World, int x, int y, int z,
		...
		TileHeatExchanger inventory = (TileHeatExchanger) par1World.getTileEntity(x, y, z);

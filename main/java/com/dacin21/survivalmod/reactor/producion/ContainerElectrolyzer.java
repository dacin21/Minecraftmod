...
{
    private TileElectrolyzer tileElectrolyzer;

    public ContainerElectrolyzer(InventoryPlayer p_i1812_1_, TileElectrolyzer p_i1812_2_)
    {
    ...
    {
        return this.tileElectrolyzer.isUseableByPlayer(p_75145_1_);
    }

...
public class RenderRune extends Render
{
    private Item field_94151_a;
    private int field_94150_f;
    ResourceLocation runeIconLocation = new ResourceLocation("survivalmod", "textures/entity/rune.png");

    public RenderRune(Item par1Item, int par2)
    {
        this.field_94151_a = par1Item;
        this.field_94150_f = par2;
    }

    public RenderRune(Item par1Item)
    {
        this(par1Item, 0);
    }

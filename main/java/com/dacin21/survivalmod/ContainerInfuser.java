...
public class ContainerInfuser extends Container
{
	...
	public ContainerInfuser(InventoryPlayer inventoryplayer, World world, int i, int j, int k)
	{
	...
	{
         craftResult.setInventorySlotContents(0, CraftingManagerInfuser.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	@Override
	...
	{
         if(worldObj.getBlock(posX, posY, posZ) != survivalmod.infuserPit)
         {
                 return false;
         } else
         {
